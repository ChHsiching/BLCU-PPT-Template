...
- Python 3.11 available; `python-pptx` not installed yet (pip install when first needed); pytest 9.x installed — run tests with `python -m pytest tests/`. `scripts/validate_deck.py` is stdlib-only.

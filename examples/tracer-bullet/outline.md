...
| 2 | agenda | 73.5 | 180 | 5 条 ≤ 6、每条最长 16.5 ≤ 30；标签「汇报大纲」= 4 ≤ 4 |
| 3 | text-formula | 61.5 | 150 | 公式不计字数（标题 16.5 ≤ 25） |
| 4 | text-formula | 56 | 150 | 同上（标题 14 ≤ 25） |
| 5 | text-image | 99.5 | 120 | 标题 13 ≤ 25；含小标题 9；4 条 ≤ 4；图注 17 ≤ 30 |
| 6 | chart-focus | 24 | 60 | 看图说话结论句（标题 9 ≤ 25） |
